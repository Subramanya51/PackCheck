...
import com.hotel.packcheck.service.FirebaseRealtimeService;
...
public class MqttService implements MqttCallback {
    ...
    public MqttService(
            ...
            CartFloorStateService cartFloorStateService,
    ...
    public void messageArrived(
        ...
        try {
            ...
            Map<String, Object> firebaseStatus =
                    new HashMap<>();
            ...
            firebaseRealtimeService.updateCartStatus(
                    cartId,
                    firebaseStatus
            );

            System.out.println(
                    "FIREBASE CART STATUS UPDATE REQUESTED"
            );
            ...
            System.out.println(
                    "Firebase Path: cartStatus/" + cartId
            );
